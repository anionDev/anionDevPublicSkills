...
If the project defines linting-rules ensure they are applied in the repository.
If the project defines linting-commands or linting-scripts run them and fix the findings.
