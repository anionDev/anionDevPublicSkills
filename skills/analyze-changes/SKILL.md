...
Summarize the changes of this branch in short and write them to the current changelog-file if a changelog exists in the current repository and if they are not already listed there.
